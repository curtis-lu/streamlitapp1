...
class barplot(object):
    ...
    * value_column: numerical value
    ...
    def __init__(self, df: pd.DataFrame = None, item_column: str = None, value_column: str = None , 
                 time_column: str = None , item_color: str = None , item_color_col: str = None, top_entries: int = 10):
        self.df = df
        self.item_column = item_column
        self.value_column = value_column
        self.time_column = time_column
        self.item_color = item_color
        self.item_color_col = item_color_col
                ...
                go.Frame(
                    ...
                    layout=go.Layout(
                        ...
                        } if self.orientation == 'vertical' else
                        {
                            'showline': True,
                            'visible': True,
                            'range': (0, self.df[self.value_column].max()*1.2)
                        },
                        yaxis={
                            'showline': True,
                            'visible': True,
    ...
    def __get_colors(self):
        if (self.item_color == None):
            ...
            self.df=self.df.rename(columns={self.item_color_col: "color"})